...
// Draw function, set matrix, calls the callList to matrix
...
// Will draw a box with no bottom.  
// The box will have the sides textured, the roof will be colored using 
...
void Building::drawSidewalk()
{
	...
	glTexCoord2f(1.0, 0.2/w);	glVertex3f(w, d, 0.1);
	...
	glTexCoord2f(0.2/d, 1.0);	glVertex3f(-w, d, 0.1);
